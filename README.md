...
## friendlyEyesBuddy - Discord Study & Productivity Bot

friendlyEyesBuddy is a Discord bot that tracks members' study and work time while offering members the ability to view their statistics and use productivity tools such as: To-do lists, pomodoro timers, reminders, and much more.

  

[**Invite friendlyEyesBuddy here**](https://discord.com/api/oauth2/authorize?client_id=944163971018145832&permissions=8&scope=bot "here"), and get started with `!help`.
...
A command list and general documentation for friendlyEyesBuddy may be found using the `!help` command, and documentation for a specific command, e.g. `config`, may be found with `!help config`.

Make sure to check the [full documentation](https://www.notion.so/izabellakis/StudyLion-Bot-Tutorials-f493268fcd12436c9674afef2e151707 "friendlyEyesBuddy Tutorial") to stay updated.
