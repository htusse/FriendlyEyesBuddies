...
group_hints = {
    ...
    'Statistics': "*friendlyEyesBuddy leaderboards and study statistics.*",
...
title = "friendlyEyesBuddy Command List"
header = """
[friendlyEyesBuddy](https://bot.studylions.com/) is a fully featured study assistant \
...
@module.cmd("help",
            group="Meta",
            desc="friendlyEyesBuddy command list.",
            aliases=('man', 'ls', 'list'))
