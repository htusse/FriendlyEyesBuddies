...
async def cmd_nerd(ctx: Context):
    ...
    embed = discord.Embed(
        ...
        title="Nerd Panel",
        description=(
            "Hi! I'm [friendlyEyesBuddy]({friendlyEyesBuddy}), a study management bot owned by "
            "[Herve Tusse]({ari}) and developed by [Conatum#5317]({cona}), with [contributors]({github})."
        ).format(
            friendlyEyesBuddy="http://studylions.com/",
